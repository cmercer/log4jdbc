...
public class Slf4jSpyLogDelegator implements SpyLogDelegator
{
   ...
   * @param returnMsg  return value of the method. null for void return types.
   ...
   */
  public void methodReturned(Spy spy, String methodCall, Object returnMsg, Object targetObject, Object... methodParams)
  {
    String classType = spy.getClassType();
